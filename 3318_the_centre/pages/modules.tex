...
\newcommand{\showrefcardsection}[1]{\subsection{Mapping of Controls}\csname refcard#1\endcsname}
\newcommand{\showrefcardsubsection}[1]{\subsubsection{Mapping of Controls}\csname refcard#1\endcsname}
