...
\newcommand{\tableofoptionsnew}[2]{
    % \foreach \settype/\dataset in {{Settings}/{#1}, {Inputs}/{#2}, {Outputs}/{#3}} {
        % \\[2mm]
    \begin{tabularx}{\linewidth}{@{}>{\hsize=0.2\hsize \columncolor{gray!10}[0pt]}XX@{}}%
        \amatica\fontsize{19pt}{19pt}\selectfont\center \rotatebox{90}{#2} & \smallskip 
...
\newcommand{\makereferencecard}[4]{
  ...
  \draw[-{Circle} ,thick] (pb_mxr-4-1.center -|pb_mxr-4-1.west) +(0,1.0em)  -- (0.35, -0.25); % node[sloped] {};
    ...
    \selannotationcol{\itemrb[2]}{mred}
    \draw[{Circle[scale=0.9]}-, thick] (-1.20,-1.1) coordinate (b1) -- (b1 |- rb_mxl-2-1.north);
    \selannotationcol{\itemrb[1]}{mred}
    \draw[{Circle[scale=0.9]}-, thick] (-1.695,-1.1) coordinate (b1) -- (b1 |- rb_mxl-1-1.north);
...
\newcommand{\modmakesection}[1]{\section{\csname modnameshort#1\endcsname{ - }\csname modnamelong#1\endcsname}\label{section:mod#1}\def\modname{\csname modnameshort#1\endcsname{ - }\csname modnamelong#1\endcsname}}

%this one is used to show reference card inside user's manual
\newcommand{\showrefcardsection}[1]{\subsection{コントロールマップ}\csname refcard#1\endcsname}
\newcommand{\showrefcardsubsection}[1]{\subsubsection{コントロールマップ}\csname refcard#1\endcsname}
...
\input{pages/modules/wto_JP.tex}
\input{pages/modules/vco_JP.tex}
\input{pages/modules/lfs_JP.tex}
\input{pages/modules/lfo_JP.tex}
\input{pages/modules/env_JP.tex}
\input{pages/modules/vca_JP.tex}
\input{pages/modules/brm_JP.tex}
\input{pages/modules/smp_JP.tex}
\input{pages/modules/noi_JP.tex}
\input{pages/modules/dly_JP.tex}
\input{pages/modules/dst_JP.tex}
\input{pages/modules/vcf_JP.tex}
\input{pages/modules/drc_JP.tex}
\input{pages/modules/clk_JP.tex}
\input{pages/modules/gat_JP.tex}
\input{pages/modules/euc_JP.tex}
\input{pages/modules/ply_JP.tex}
\input{pages/modules/rng_JP.tex}
\input{pages/modules/qnt_JP.tex}
\input{pages/modules/arp_JP.tex}
\input{pages/modules/out_JP.tex}
