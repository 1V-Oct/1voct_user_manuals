\def\eucset{
  ...
  {{CV to VOUT}}/{{Convert CV input to VOUT output}/{Convert CV input to VOUT output that allows sending output to external modules. This overrides VOUT buffers so must be used withotu OUT module}}%
